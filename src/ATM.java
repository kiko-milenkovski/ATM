...
public class ATM {
    ...
    public static User mainMenuPrompt(Bank theBank, Scanner sc) {
        ...
        do {
            ...
            // try to get the user object corresponding to the ID and pin code combo
    ...
    /**
     * Show the transaction history for account
    ...
    /**
     * Process transferring fund from one account to another
     * @param theUser  the logged-in User object
    ...
    public static void transferFunds(User theUser, Scanner sc) {
            ...
            do {
                System.out.printf("Enter the number (1-%d) of the account\n" +
                        "to transfer form: ", theUser.numAccounts());
